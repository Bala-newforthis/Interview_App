...
async function generateResumePdf ({resume, selfDescription, jobDescription}) {
  ...
  const prompt = `Generate a resume for a candidate with the following details :
                  ...
                  The resume should be tailored for the given job description and should highlight the candidate's strength and relevant experience. The Html content should be well-formatted and structured , making it easy and visible appearing .
                  ...
                  The resume should not be so lengthy, it should ideally be 1-2 pages long when converted to PDF.Focus on quality rather than  quantity and make sure to include all the relevant information that can .
                  `
